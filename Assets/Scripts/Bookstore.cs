...
public class Bookstore : MonoBehaviour
{
    ...
    public static BookStoreItem[] BS_Items =
    {
            ...
            new BookStoreItem ("CompTia A+ Certification Prep Questions",   80f, "IT~SE",       "Book_1", "An in-depth guide to the A+ Certification exams, with troubleshooting steps and previous exam examples.", ""),
            ...
            new BookStoreItem ("I Inc., Career Planning and Personal" + 
                                                    " Entrepreneurship",    50f, "IT~HR~SE",    "Book_1", "Teaches students how to market themselves effectively in today's competitive professional environment.", ""),
